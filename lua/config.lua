...
vim.opt.grepprg = "rg --vimgrep --hidden --smart-case --no-heading --trim --follow --glob '!.git' --glob '!node_modules' --glob '!dist' --glob '!build' --glob '!libs' --glob '!env' --glob '!target' --glob '!out' --glob '!public' --glob '!coverage' --glob '!coverage-report' --glob '!coverage-summary' --glob '!coverage-final.json' --glob '!coverage-final.json' --glob '!coverage-final.json' --glob '!coverage-final.json'"
