...
vim.keymap.set("n", "<leader><C-t>", "<cmd>silent !tmux neww tmux-sessionizer<cr>", { desc = "Sessionizer" })
vim.keymap.set("n", "<leader><C-p>", "<cmd>silent !tmux neww tmux-run atac<cr>", { desc = "ATAC" })
vim.keymap.set("n", "<leader><C-d>", "<cmd>silent !tmux neww tmux-run rainfrog<cr>", { desc = "DBViewer" })
