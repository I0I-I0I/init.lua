...
vim.keymap.set("n", "<C-g><C-g>", "<cmd>silent !tmux neww tmux-run lazygit<cr>", { desc = "Sessionizer" })
vim.keymap.set("n", "<C-g><C-r>", "<cmd>silent !tmux neww tmux-run atac<cr>", { desc = "Sessionizer" })
vim.keymap.set("n", "<C-g><C-d>", "<cmd>silent !tmux neww tmux-run lazysql<cr>", { desc = "Sessionizer" })
